...
public class UsersService {
    ...
    public void executeCustomQuery() {
        try {
            ...
            System.out.println(properties.getProperty("community.sql.custom-query"));
            ResultSet rs = statement.executeQuery(properties.getProperty("community.sql.custom-query"));
